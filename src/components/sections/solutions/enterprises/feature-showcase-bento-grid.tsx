            ...
            <HoverTilt className="h-full">
              <Card className="p-8 h-full bg-gradient-to-br from-background to-muted/20 border-2 hover:border-primary/50 transition-colors">
                <div className="flex flex-col h-full">
                  ...
                  <Typography variant="h3" className="mb-3">{t('features.0.title')}</Typography>
            ...
            <HoverTilt className="h-full">
              <Card className="p-8 h-full bg-gradient-to-br from-background to-muted/20 border-2 hover:border-primary/50 transition-colors">
                <div className="flex flex-col h-full">
                  ...
                  <Typography variant="h3" className="mb-3">{t('features.1.title')}</Typography>
                  <Typography variant="body" className="text-muted-foreground flex-grow">
            ...
            <HoverTilt className="h-full">
              <Card className="p-8 h-full bg-gradient-to-br from-background to-muted/20 border-2 hover:border-primary/50 transition-colors">
                <div className="flex flex-col h-full">
                  ...
                  <Typography variant="h3" className="mb-3">{t('features.2.title')}</Typography>
                  <Typography variant="body" className="text-muted-foreground flex-grow">
            ...
            <HoverTilt className="h-full">
              <Card className="p-8 h-full bg-gradient-to-br from-background to-muted/20 border-2 hover:border-primary/50 transition-colors">
                <div className="flex flex-col h-full">
                  ...
                  <Typography variant="h3" className="mb-3">{t('features.3.title')}</Typography>
                  <Typography variant="body" className="text-muted-foreground flex-grow">
            ...
            <HoverTilt className="h-full">
              <Card className="p-8 h-full bg-gradient-to-br from-background to-muted/20 border-2 hover:border-primary/50 transition-colors">
                <div className="flex flex-col h-full">
                  ...
                  <Typography variant="h3" className="mb-3">{t('features.4.title')}</Typography>
                  <Typography variant="body" className="text-muted-foreground flex-grow">
            ...
            <HoverTilt className="h-full">
              <Card className="p-8 h-full bg-gradient-to-br from-background to-muted/20 border-2 hover:border-primary/50 transition-colors">
                <div className="flex flex-col h-full">
                  ...
                  <Typography variant="h3" className="mb-3">{t('features.5.title')}</Typography>
                  <Typography variant="body" className="text-muted-foreground flex-grow">
