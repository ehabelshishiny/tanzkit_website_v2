...
export const appsData: Record<string, AppConfig> = {
  'operator-dashboard': {
    ...
    screenshots: [
      ...
      '/assets/apps_screenshots/operator-dashboard/7.png',
      '/assets/apps_screenshots/operator-dashboard/8.png',
      '/assets/apps_screenshots/operator-dashboard/9.png',
      '/assets/apps_screenshots/operator-dashboard/10.png',
      '/assets/apps_screenshots/operator-dashboard/11.png',
      '/assets/apps_screenshots/operator-dashboard/12.png',
      '/assets/apps_screenshots/operator-dashboard/13.png',
      '/assets/apps_screenshots/operator-dashboard/14.png',
      '/assets/apps_screenshots/operator-dashboard/15.png',
      '/assets/apps_screenshots/operator-dashboard/16.png',
      '/assets/apps_screenshots/operator-dashboard/17.png',
      '/assets/apps_screenshots/operator-dashboard/18.png',
  ...
  'enterprise-dashboard': {
    ...
    screenshots: [
      ...
      '/assets/apps_screenshots/enterprise-dashboard/7.png',
      '/assets/apps_screenshots/enterprise-dashboard/8.png',
      '/assets/apps_screenshots/enterprise-dashboard/9.png',
      '/assets/apps_screenshots/enterprise-dashboard/10.png',
      '/assets/apps_screenshots/enterprise-dashboard/11.png',
      '/assets/apps_screenshots/enterprise-dashboard/12.png',
      '/assets/apps_screenshots/enterprise-dashboard/13.png',
    ]
  },
  'supervisor': {
    id: 'supervisor',
    ...
    screenshots: [
      ...
      '/assets/apps_screenshots/supervisor/7.png',
      '/assets/apps_screenshots/supervisor/8.png',
    ]
  },
  'driver': {
    id: 'driver',
